...
const onClose = function () {
  ...
  state.value = { ...currentState, showSideBar: false };
  return true;
};

export default function SideBar() {
  const { showSideBar } = state.value;
  return (
    <>
      {showSideBar
        ? (
          <div>
            ...
            <div class="fixed inset-0 z-10 gap-y-5 overflow-y-auto border-gray-200 bg-white px-6 w-[300px]">
              <div class="h-16 shrink-0 items-center">
                <img
                  class="h-8 w-auto"
