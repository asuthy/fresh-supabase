import { fromBase58, toBase58 } from "../util/base58.ts";
import { ENCRYPTION_KEY_LENGTH, ID_LENGTH } from "./constants.ts";
/**
...
export function decodeCompositeKey(
  compositeKey: string,
): { id: string; encryptionKey: Uint8Array; version: number } {
